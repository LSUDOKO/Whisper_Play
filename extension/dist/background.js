...
function connectToSignalingServer() {
  return _connectToSignalingServer.apply(this, arguments);
} // Handle incoming signaling messages
function _connectToSignalingServer() {
  _connectToSignalingServer = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
    var ws;
        ...
        case 1:
          try {
                ...
                return _regenerator().w(function (_context2) {
                  while (1) switch (_context2.p = _context2.n) {
                    ...
                    case 2:
                      _context2.p = 2;
                      _t5 = _context2.v;
                      console.error('Error handling signaling message:', _t5);
                    case 3:
            ...
            ws.onclose = function () {
              ...
              state.retryCount++;
              setTimeout(function () {
                return connectToSignalingServer();
              }, state.retryTimeout);
            };
...
function _handleSignalingMessage() {
  _handleSignalingMessage = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(data) {
    var answer, _t6;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.n) {
        case 0:
          _t6 = data.type;
          _context4.n = _t6 === 'offer' ? 1 : _t6 === 'ice-candidate' ? 6 : 8;
          break;
        case 1:
          if (!state.peer) {
            _context4.n = 5;
          ...
          _context4.n = 2;
          return state.peer.setRemoteDescription(new RTCSessionDescription(data.offer));
        case 2:
          _context4.n = 3;
          return state.peer.createAnswer();
        case 3:
          answer = _context4.v;
          _context4.n = 4;
          return state.peer.setLocalDescription(answer);
        case 4:
        ...
        case 6:
          ...
          _context4.n = 7;
          return state.peer.addIceCandidate(new RTCIceCandidate(data.candidate));
        case 7:
          return _context4.a(3, 8);
        case 8:
...
function initializePeerConnection() {
  return _initializePeerConnection.apply(this, arguments);
} // Message handling from popup and content scripts
function _initializePeerConnection() {
  _initializePeerConnection = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
    var config, _t8;
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.p = _context6.n) {
        ...
        case 1:
          ...
          state.peer.ondatachannel = function (event) {
            ...
            channel.onmessage = /*#__PURE__*/function () {
              var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(event) {
                var data, tabs, _t7;
                return _regenerator().w(function (_context5) {
                  while (1) switch (_context5.p = _context5.n) {
                    ...
                    case 3:
                      _context5.p = 3;
                      _t7 = _context5.v;
                      console.error('Error handling data channel message:', _t7);
                    case 4:
        ...
        case 2:
          _context6.p = 2;
          _t8 = _context6.v;
          console.error('Error initializing peer connection:', _t8);
...
chrome.runtime.onMessage.addListener(function (message, sender, sendResponse) {
  _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var success, tabs, _tabs, _t, _t2, _t3, _t4;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _t = message.type;
          _context.n = _t === 'connect' ? 1 : _t === 'disconnect' ? 4 : _t === 'setLanguage' ? 5 : _t === 'setVolume' ? 10 : _t === 'getState' ? 15 : 16;
          break;
        case 1:
          _context.n = 2;
          return connectToSignalingServer();
        ...
        case 8:
          _context.p = 8;
          _t2 = _context.v;
          console.error('Error setting language:', _t2);
          sendResponse({
            success: false,
            error: _t2.message
          });
        ...
        case 11:
          ...
          _context.n = 12;
          return chrome.tabs.sendMessage(_tabs[0].id, {
            type: 'volumeChange',
        ...
        case 13:
          _context.p = 13;
          _t3 = _context.v;
          console.error('Error setting volume:', _t3);
          sendResponse({
            success: false,
            error: _t3.message
          });
        ...
        case 18:
          _context.p = 18;
          _t4 = _context.v;
          console.error('Error handling message:', _t4);
          sendResponse({
            success: false,
            error: _t4.message
          });
